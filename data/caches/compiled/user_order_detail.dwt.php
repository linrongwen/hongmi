...
<section class="user-order-detail" style="border-top:none;">
  <div class="user-order">
    ...
    <p><?php echo $this->_var['lang']['order_number']; ?>：<span><?php echo $this->_var['order']['order_sn']; ?></span> <a href="<?php echo url('user/msg_list', array('order_id'=>$this->_var['order']['order_id']));?>" type="button" class="btn btn-info" style="font-size:12px;padding:3px;">[<?php echo $this->_var['lang']['business_message']; ?>]</a></p>
...
<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> 
  <?php echo $this->_var['order']['handler']; ?> 
    ...
    <a href="<?php echo $this->_var['order']['order_tracking']; ?>" type="button" class="btn btn-info ect-btn-info ect-colorf ect-bg"><?php echo $this->_var['lang']['order_tracking']; ?></a>
    <?php endif; ?>
</div>
